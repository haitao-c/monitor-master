...
INSERT INTO `monitor`.`sys_device_items`(`id`,  `device_ip`, `cpu_status`, `memory_status`, `network_status`, `db_status`, `business_status`, `datetime`,`sys_id`) VALUES (1,  '127.0.0.1', 0, 1, 1, 1, 1, '2018-07-19 15:50:08',1);
