...
INSERT INTO `monitor`.`warn`(`id`, `device_ip`, `warn_info`, `datetime`,`warn_type`) VALUES (1, '127.0.0.1', 'CPU异常', '2018-07-19 15:50:08','cpu_status');
INSERT INTO `monitor`.`warn`(`id`, `device_ip`, `warn_info`, `confirm`, `datetime`,`warn_type`) VALUES (2, '127.0.0.1', 'Network异常', '手动修复','2018-07-19 15:50:08','network_status');
INSERT INTO `monitor`.`warn`(`id`, `device_ip`, `warn_info`, `datetime`,`warn_type`) VALUES (3, '127.0.0.3', 'Memory异常', '2018-07-19 15:50:08','cpu_status');
INSERT INTO `monitor`.`warn`(`id`, `device_ip`, `warn_info`, `datetime`,`warn_type`) VALUES (4, '127.0.0.1', 'DB异常', '2018-07-23 10:42:06','db_status');
