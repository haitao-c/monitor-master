...
public class WarnDaoProvider{
    public String insertAll(Map map) {
        ...
        sb.append("(device_ip, warn_info, find_time, warn_type, sys_id, warn_level) ");
        sb.append("VALUES ");
        MessageFormat mf = new MessageFormat("(#'{'list[{0}].deviceIP}, #'{'list[{0}].warnInfo}, #'{'list[{0}].findTime}, #'{'list[{0}].warnType}, #'{'list[{0}].sysId}, #'{'list[{0}].warnLevel})");
