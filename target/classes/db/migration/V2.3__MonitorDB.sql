...
INSERT INTO `monitor`.`sys_device_items`(`id`,  `device_ip`, `cpu_status`, `memory_status`, `network_status`, `db_status`, `business_status`, `datetime`,`sys_id`) VALUES (1,  '127.0.0.1', 1, 1, 1, 1, 1, '2018-07-19 15:50:08',1);
INSERT INTO `monitor`.`sys_device_items`(`id`,  `device_ip`, `cpu_status`, `memory_status`, `network_status`, `db_status`, `business_status`, `datetime`,`sys_id`) VALUES (2,  '127.0.0.2', 1, 1, 1, 1, 1, '2018-07-19 15:16:55',1);
...
INSERT INTO `monitor`.`sys_device_items`(`id`,  `device_ip`, `cpu_status`, `memory_status`, `network_status`, `db_status`, `business_status`, `datetime`,`sys_id`) VALUES (5,  '127.0.0.5', 1, 1, 1, 1, 1, '2018-07-19 15:16:58',3);
...
INSERT INTO `monitor`.`sys_device_items`(`id`,  `device_ip`, `cpu_status`, `memory_status`, `network_status`, `db_status`, `business_status`, `datetime`,`sys_id`) VALUES (8,  '127.0.0.8', 1, 1, 1, 1, 1, '2018-07-19 15:17:58',5);
...
/*INSERT INTO `monitor`.`warn`(`id`, `device_ip`, `warn_info`, `find_time`,`warn_type`) VALUES (1, '127.0.0.1', 'CPU异常', '2018-07-19 15:50:08','cpu_status');
INSERT INTO `monitor`.`warn`(`id`, `device_ip`, `warn_info`, `confirm`, `find_time`,`warn_type`) VALUES (2, '127.0.0.1', 'Network异常', '手动修复','2018-07-19 15:50:08','network_status');
INSERT INTO `monitor`.`warn`(`id`, `device_ip`, `warn_info`, `find_time`,`warn_type`) VALUES (3, '127.0.0.3', 'Memory异常', '2018-07-19 15:50:08','cpu_status');
INSERT INTO `monitor`.`warn`(`id`, `device_ip`, `warn_info`, `find_time`,`warn_type`) VALUES (4, '127.0.0.1', 'DB异常', '2018-07-23 10:42:06','db_status');
*/
